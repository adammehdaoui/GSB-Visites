...
<center>
    <div class="row">
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="text-primary fw-bold">Veuillez choisir le rapport pour lequel vous voulez ajouter ou supprimer un échantillon offert.</h5>
                </div>
            </div>
        </div>
        <div class="col-4"></div>
    ...
    <div class="row">
        ...
        <div class="col-2">
            ...
            <form action="" method="post">
                ...
                <div>
                    <button class="btn btn-primary btn-xl" type="submit" value="submit">Appliquer la date</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="d-flex justify-content-center">
            <table style="width: 50%;" class="table">
                ...
                <tbody>
                <?php for($i=0;$i<count($rapports);$i++){ ?>
                    <tr>
                        ...
                        <td><a href="./?action=medicaments&type=AddOrDelMedicament&id=<?=$rapports[$i]->getId()?>"><img src="assets/images/plus.jpg"></a></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
